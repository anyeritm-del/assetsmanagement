...
import { listItemsByProperty, createItem } from "../lib/repositories/items";
...
async function main() {
  ...
  const itemSeeds: ItemSeed[] = [
    ...
    { name: "Access Point Indoor Dual Band MR36", code: "AST-NET-003", serial_number: "SN-NET-8003", brand: "Cisco Meraki", category: "Network", item_type: "fixed_asset", quantity: 1, acquisition_value: 4100000, book_value: 2500000, status: "active", lifetime_years: 5, end_of_lifetime_date: daysFromNow(20), warranty_months: 24, purchaseOrderIndex: 3, articleIndex: 8, roomIndex: 6, equipmentIndex: 1, departmentIndex: 7, assignedEmployeeIndex: 1, notes: "" },
  ];
