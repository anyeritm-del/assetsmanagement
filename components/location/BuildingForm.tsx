...
import type { ActionResult } from "@/lib/actions/buildings";
...
export function BuildingForm({ propertyId, building, action }: BuildingFormProps) {
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            min={0}
            name="total_floor"
            defaultValue={building?.total_floor ?? 1}
            required
            className="mt-1 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 dark:border-slate-700 dark:bg-slate-800"
          />
        </div>
