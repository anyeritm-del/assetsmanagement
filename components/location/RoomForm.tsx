...
import type { ActionResult } from "@/lib/actions/rooms";
...
export function RoomForm({ propertyId, buildingId, floorId, room, action }: RoomFormProps) {
  const router = useRouter();
  const backHref = `/location/${buildingId}/floors/${floorId}/rooms`;
