...
import type { Item, MovementRequest, MovementRequestItem, User } from "@/lib/types";
...
export function MovementReportView({
  ...
  itemsById,
  usersById,
}: MovementReportViewProps) {
  const [dateFrom, setDateFrom] = useState("");
  const [dateTo, setDateTo] = useState("");
  const [results, setResults] = useState<MovementRequest[]>(requests);
