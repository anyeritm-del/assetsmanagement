...
import type { ActionResult } from "@/lib/actions/maintenanceCategories";
...
export function MaintenanceCategoryForm({ category, action }: MaintenanceCategoryFormProps) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div className="flex justify-end gap-3 pt-2">
        <button
          type="button"
          onClick={() => router.push("/maintenance-categories")}
